...
\twopart{
\fraccc{\Gamma \vd e : \tau}{\Gamma \vd \kw{val}~x~\kw{=} ~e : \{x:\tau\}}
}{
...
\onepart{
\fraccc{\Gamma,x_1:\tau_1,\cdots,x_n:\tau_n \vd e : \tau}{\Gamma \vd \kw{fun}~f~\kw{(}x_1,\cdots,x_n\kw{)}~\kw{=} ~e : \{f:\kw{(}\tau_1,\cdots,\tau_n\kw{)} \rarr \tau\}}
}

\section{Futhark Evaluation Semantics}

In this section we develop a simple big-step semantics for Futhark programs. Besides from the notion of values, which has already been introduced in the previous section
