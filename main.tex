...
We can rewrite this using \fw{loop} syntax:
...
The \fw{loop} syntax shown above is actually just syntactical sugar
...
therefore required to use \fw{loop} syntax for sequential loops.
