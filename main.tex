...
\begin{verbatim}
$ cat input | ./dotprod-opencl -t /dev/stderr -r 10
Warning: Device limits tile size to 16 (setting was 32)
891
1074
1239
1170
...
These runtimes are now much better.  And importantly --- there are
...
introduce a new program, texttt{sumsquares.fut}, with smaller data
sets for convenience:

\lstinputlisting{src/sumsquares.fut}
...
To determine the work of the algorithm, we first determine the work
done by \kw{padpow2}. MEMO: to come...

It is an exercise for the reader to compare the performance of the reduction code to the performance of the built-in
