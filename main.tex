...
=======
parameters.  Futhark does not yet support type inference.  As a
concrete example, here is the parallel definition of the factorial
function in Futhark:

\begin{lstlisting}
let fact (n: i32): i32 = reduce (*) 1 [1...n]
>>>>>>> Refresh some of the text.
\end{lstlisting}
...
function definitions in Section~\ref{sec:polymorphism}, where we will
look at more advanced features, such as parametric polymorphism and
implicit size parameters.
...
\section{Polymorphic Functions and Size Parameters}
