...
In this book we shall develop a performance reasoning model for a
...
shall require the programmer to perform certain kinds of flattening manually.
...
\begin{lstlisting}[mathescape=true]
  $p$ ::= $x$  |  ($p_1$,...,$p_n$)  |  $p_1$ $p_2$
  $F$ ::= fn $p$ => $e$
  $D$ ::= fun $f$ $p$ = $e$  |  $D_1$ $D_2$  |  val $p$ = $e$
  $b$ ::= true  |  false  |  $n$  |  $r$
  $e$ ::= $b$  |  let $p$ = $e$ in $e$  |  ($e_1$,...,$e_n$)
      | f $e_1$ ... $e_n$
      | map $f$ $e$
      | scan $F$ $e$ $e$
      | reduce $F$ $e$ $e$
