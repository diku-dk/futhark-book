...
order is shown in Figure~\ref{fig:radix_sort}.
...
takes care of moving all elements with the \kw{bit\_n} set to the end
of the array. The main function \kw{rsort} takes care of iterating the
